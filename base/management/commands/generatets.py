...
class Command(BaseCommand):
    def handle(self, *args, **options):
        ...
        generate_ts('./competition.ts', context='competition',
                    trim_serializer_output=True)
        generate_ts('./personal.ts', context='personal',
                    trim_serializer_output=True)
        generate_ts('./problem_database.ts', context='problem_database',
                    trim_serializer_output=True)
