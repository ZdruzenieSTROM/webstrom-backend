...
class ActivityType(models.Model):
    ...
    seminar = models.ForeignKey(
        Seminar, default=1, on_delete=models.CASCADE, verbose_name='seminár')
...
class Activity(models.Model):
    ...
    activity_type = models.ForeignKey(
        ActivityType, default=1, on_delete=models.CASCADE, verbose_name='typ aktivity')
...
class Media(models.Model):
    ...
    data = models.ImageField(verbose_name='priložené súbory')
    problem = models.ForeignKey(
        Problem, default=1, on_delete=models.CASCADE, verbose_name='príklad')
    soft_deleted = models.BooleanField(default=False)

    def __str__(self):
        return f'{self.problem} - {self.data.name}'
...
class ProblemActivity(models.Model):
    ...
    activity = models.ForeignKey(
        Activity, default=1, on_delete=models.CASCADE, verbose_name='aktivita')
    difficulty = models.ForeignKey(
        Difficulty, default=1, on_delete=models.CASCADE, verbose_name='náročnosť')
...
class ProblemTag(models.Model):
    ...
    tag = models.ForeignKey(
        Tag, default=1, on_delete=models.CASCADE, verbose_name='aktivita')
